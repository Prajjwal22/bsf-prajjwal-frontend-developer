...
export default function Hero() {
  return (
    <section className="h-screen  bg-hero-rocket h-h-800 bg-cover bg-center md:bg-right flex w-full items-center justify-start ">
      <div className="p-8 flex flex-col gap-2 items-start w-3/4 animate-bounce duration-6000">
        <span className="text-2xl md:text-4xl text-white font-bold uppercase bg-black/50 p-2">
          Discover SpaceX Rockets 🚀 and Capsules
        </span>
        <span className="text-2xl md:text-4xl text-white font-bold uppercase bg-black/50 p-2">
          Your Gateway to the Future of Space Travel
        </span>
        <span className="text-white text-sm md:text-lg w-3/4">
